...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quantstats-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14149&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quantstats-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quantstats` can be installed with:

```
conda install quantstats
```

It is possible to list all of the versions of `quantstats` available on your platform with:
